...
def play(word):
    ...
    while tries:
        ...
        elif t in word and t not in guessed_letters:
            if word.count(t) > 1:
                ...
                word_completion[word.index(t)] = t

            guessed_letters.append(t)
            print('Правильно!')

        elif t in guessed_letters:
    ...
    print('Желаете сыграть снова(да/нет)?')
    while True:
        answer = input().lower()
        if answer == 'нет':
            break
